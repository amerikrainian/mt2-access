...
{
    internal sealed class ProxyRoomAbilityCard : GameObjectElement
    {
        private readonly RoomAbilityCardUI _cardUI;

        public ProxyRoomAbilityCard(RoomAbilityCardUI cardUI, ShinyShoe.IGameUIComponent selectable)
            : base(
                selectable,
                typeKey: null,
                label: null)
